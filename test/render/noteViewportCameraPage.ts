...
async function setup(id:string,kind="far",font=1,external=1,initialDoc?:string) {
 ...
 if(!ids.has(path)) {
  ...
  const points=kind==="empty"?[]:kind==="edge"?[[6,120]]:kind==="point"?[[80,120]]:kind==="huge"?[[200,200],[9_000_000,9_000_000]]:kind==="below-minimum"?[[200,200],[100000,100000]]:kind==="former-far"?[[200,200],[18000,22000]]:kind==="paper-scaled"?[[200,200],[900,1100]]:[[200,200],[1800,2200]];
